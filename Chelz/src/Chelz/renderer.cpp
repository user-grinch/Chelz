...
bool Chelz::Renderer::IsLightTheme() {
...
void Chelz::Renderer::ApplyLightTheme()
{
...
void Chelz::Renderer::ApplyDarkTheme()
{
    ImGuiStyle *style = &ImGui::GetStyle();
    ImVec4* colors = style->Colors;
...
Chelz::eDeviceState Chelz::Renderer::CreateDevice(HWND hWnd)
{
    if (pd3dDevice)
    {
...
void Chelz::Renderer::CleanupDevice()
{
#ifdef CHELZ_LEGACY_SUPPORT
    if (pD3D) 
    { 
...
#ifdef CHELZ_LEGACY_SUPPORT
void Chelz::Renderer::ResetDevice()
{
...
#else
void Chelz::Renderer::CreateRenderTarget()
{
...
void Chelz::Renderer::CleanupRenderTarget()
{
...
LRESULT WINAPI Chelz::Renderer::WndProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
...
void Chelz::Renderer::ProcessThemes()
{
    BOOL useDarkMode = TRUE;
    bool isLightMode = IsLightTheme();
    static bool prevIsLightMode = !isLightMode;
    static Chelz::eTheme prevTheme = eTheme::SystemDefault;
...
void Chelz::Renderer::DrawLayer(Specification &Spec)
{
    if (!hwnd)
    {
        return;
    ...
    pd3dDeviceContext->ClearRenderTargetView(pRenderTargetView, clear_color_with_alpha);
...
void Chelz::Renderer::Init(const Specification &Spec)
{
...
void Chelz::Renderer::SetThemeMode(eTheme themeMode)
{
    Theme = themeMode;
}

Chelz::eTheme Chelz::Renderer::GetThemeMode()
{
    return Theme;
}

void Chelz::Renderer::Shutdown()
{
#ifdef CHELZ_LEGACY_SUPPORT
